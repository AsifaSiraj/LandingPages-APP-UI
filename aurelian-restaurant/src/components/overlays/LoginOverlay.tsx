...
export default function LoginOverlay() {
  const { setActiveView, login, setActiveView: openSignup } = useAppStore();
  ...
  return (
    <motion.div
      ...
      className="fixed inset-0 z-[60] bg-deep-black/95 backdrop-blur-2xl flex items-center justify-center"
      ...
      >
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-subtext text-sm" style={{ fontFamily: 'var(--font-inter)' }}>
            Sign in to access your reservations, orders, and preferences
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center gap-2 cursor-pointer">
              <input type="checkbox" className="w-4 h-4 accent-gold rounded-none" />
              <span className="text-subtext text-xs" style={{ fontFamily: 'var(--font-inter)' }}>Remember me</span>
            </label>
            <button type="button" className="text-gold text-xs hover:text-gold-champagne transition-colors" style={{ fontFamily: 'var(--font-inter)' }}>
              Forgot password?
            </button>
          </div>
